  ...
  return (
    <FormContainer >
                <form action="" id='formD'>
                    ...
                    <div className='contenedor'>
                        <input type="text" placeholder='Nombres' className='caja1' required minLength={4} maxLength={15} pattern="[A-Za-z]+" onFocus={handleFocus} onBlur={handleBlur}/>
                        <input type="text" placeholder='Apellidos' className='caja1' required minLength={5} maxLength={20} pattern="[A-Za-z]+" onFocus={handleFocus} onBlur={handleBlur}/>
                    </div>
                    <div className='contenedor3'>
                        <input type="email " placeholder='Email'className='caja2' required minLength={11}/>
                        <input type="password" placeholder='Contraseña'className='caja2' required minLength={8} maxLength={12}/>
                    </div>
                    <br />
                    <br />
