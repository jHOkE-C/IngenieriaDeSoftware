...
// Consulta SQL para seleccionar los cursos más nuevos
$sql = "SELECT c.*, CONCAT(d.firstname, ' ', d.lastname) AS nombre_docente 
        FROM curso AS c
        INNER JOIN docente AS d ON c.docente_id = d.id
        ORDER BY c.idCurso DESC"; // Ordenar por ID de curso de forma descendente para obtener los cursos más nuevos primero
