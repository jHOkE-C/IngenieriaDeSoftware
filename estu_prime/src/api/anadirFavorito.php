...
if ($result_check->num_rows > 0) {
    ...
    $sql_update = "UPDATE estudiantedecurso SET CURSOFAVORITO = 1 WHERE IDESTUDIANTE = '$id' AND IDCURSO = '$idCurso'";
    if ($conn->query($sql_update) === TRUE) {
        $response = array("success" => true, "mensaje" => "Curso añadido a favoritos");
    } else {
