...
<?php session_start(); ?>
  <section class="bg-barra border-b border-black/5">
    <div class="w-full mx-auto md:px-12 px-8 max-w-7xl lg:px-16">
      <div x-data="{ open: false }" class="relative flex flex-col w-full py-5 mx-auto bg-barra md:items-center md:justify-between md:flex-row md:px-6">
        <div class="flex flex-row items-center justify-between lg:justify-start">
          ...
          <button @click="open = !open" class="inline-flex items-center justify-center p-2 text-gray-400 hover:text-black focus:outline-none focus:text-black lg:hidden">
        ...
        <nav :class="{'flex': open, 'hidden': !open}" class="flex-col items-center flex-grow hidden md:pb-0 md:flex md:justify-end md:flex-row">
          <a class="px-2 lg:px-6 py-2 md:px-3 text-sm font-medium text-fondo hover:text-boton lg:ml-auto" href="/#aboutUs">Acerca de Nostros</a>
          <a class="px-2 lg:px-6 py-2 md:px-3 text-sm font-medium text-fondo hover:text-boton" href="/#pricing">Precios</a>

          <a class="px-2 lg:px-6 py-2 md:px-3 text-sm font-medium text-fondo hover:text-boton" href="/teachOnEstuPrime">
            Como Enseñar</a>

          <div class="inline-flex items-center gap-2 list-none lg:ml-auto">
            <a href="registro.php" class="inline-flex items-center h-8 justify-center px-4 py-2 text-sm font-medium text-fondo bg-boton rounded-lg group focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 hover:bg-fondo active:bg-gray-200 active:text-input focus-visible:outline-black hover:text-boton">
              Registrarse
            </a>
            <a href="login.php" class="inline-flex items-center h-8 justify-center px-4 py-2 text-sm font-medium text-fondo bg-boton rounded-lg group focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 hover:bg-fondo active:bg-gray-200 active:text-input focus-visible:outline-black hover:text-boton">
              Iniciar Sesion
            </a>
          </div>
        </nav>
...
<?php endif; ?>
          ...
          <form id="signupForm" action="validar.php" method="post">
