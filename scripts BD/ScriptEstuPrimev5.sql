...
DROP TABLE IF EXISTS `inputtext`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `inputtext` (
  `IDINTEXT` int NOT NULL AUTO_INCREMENT,
  `IDCURSO` int DEFAULT NULL,
  `POSITIONTEXT` varchar(100) DEFAULT NULL,
  `STRINGTEXT` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`IDINTEXT`),
  KEY `FK_INPUTTEX_POSEETEXT_CURSO` (`IDCURSO`),
  CONSTRAINT `FK_INPUTTEX_POSEETEXT_CURSO` FOREIGN KEY (`IDCURSO`) REFERENCES `curso` (`IDCURSO`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `inputtext` WRITE;
/*!40000 ALTER TABLE `inputtext` DISABLE KEYS */;
/*!40000 ALTER TABLE `inputtext` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `inputvideo`
--

DROP TABLE IF EXISTS `inputvideo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `inputvideo` (
  `IDINVIDEO` int NOT NULL AUTO_INCREMENT,
  `IDCURSO` int DEFAULT NULL,
  `POSITIONVIDEO` varchar(100) DEFAULT NULL,
  `STRINGRUTA` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`IDINVIDEO`),
  KEY `FK_INPUTVID_POSEEVIDE_CURSO` (`IDCURSO`),
  CONSTRAINT `FK_INPUTVID_POSEEVIDE_CURSO` FOREIGN KEY (`IDCURSO`) REFERENCES `curso` (`IDCURSO`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `inputvideo`
--

LOCK TABLES `inputvideo` WRITE;
/*!40000 ALTER TABLE `inputvideo` DISABLE KEYS */;
/*!40000 ALTER TABLE `inputvideo` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-05-18 10:19:45
